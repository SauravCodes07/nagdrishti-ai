...
export default function AdminLayout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#0B0F17] text-slate-900 dark:text-slate-100 flex flex-col md:flex-row antialiased selection:bg-teal-500 selection:text-white transition-colors duration-200">
      {/* ========================================================================= */}
      {/* DESKTOP ADMIN FIXED LEFT SIDEBAR */}
      {/* ========================================================================= */}
      <aside
          ...
          <nav className="p-3 space-y-1.5">
            ...
            {navItems.map((item) => {
              ...
              return (
                ...
                >
                  <Icon className={`w-5 h-5 shrink-0 ${isActive ? "text-teal-600 dark:text-teal-400" : ""}`} />
          ...
          {!sidebarCollapsed ? (
            <div className="p-3 rounded-2xl bg-slate-100 dark:bg-[#131B2A] border border-slate-200 dark:border-[#1E293B] space-y-2">
              ...
              <button
                ...
                className="w-full py-1.5 rounded-xl bg-red-50 dark:bg-red-500/10 hover:bg-red-100 dark:hover:bg-red-500/20 text-red-600 dark:text-red-400 font-bold text-[11px] flex items-center justify-center gap-1.5 transition"
              >
            ...
            <button
              onClick={handleLogout}
              className="w-full p-2.5 rounded-xl bg-red-50 dark:bg-red-500/10 text-red-600 dark:text-red-400 flex justify-center hover:bg-red-100"
              title="Sign Out"
            >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2 text-[11px] font-bold text-slate-400 dark:text-slate-500">
                <Link href="/admin" className="hover:text-teal-600 dark:hover:text-teal-400 transition">
                  Command HQ
                </Link>
                <span>/</span>
          ...
          <div className="w-72 bg-white dark:bg-[#0F172A] h-full p-5 flex flex-col justify-between border-r border-slate-200 dark:border-[#1E293B] shadow-2xl animate-in slide-in-from-left duration-200">
            <div className="space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-slate-200 dark:border-[#1E293B]">
                ...
                <button onClick={() => setMobileDrawerOpen(false)} className="p-1.5 text-slate-500">
                  <X className="w-5 h-5" />
                </button>
              </div>
            ...
            <div className="space-y-2 pt-4 border-t border-slate-200 dark:border-[#1E293B]">
              ...
              <button
                onClick={handleLogout}
                className="w-full py-2.5 rounded-xl bg-red-600 text-white font-bold text-xs flex items-center justify-center gap-2"
              >
                <LogOut className="w-4 h-4" />
                <span>Sign Out</span>
              </button>
