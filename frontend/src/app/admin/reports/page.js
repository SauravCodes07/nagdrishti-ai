        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {filteredReports.map((rep) => {
            ...
            return (
              <div
                key={rep.id}
                className="bg-white dark:bg-[#131B2A] border border-slate-200 dark:border-[#1E293B] rounded-3xl p-5 shadow-xl space-y-4 flex flex-col justify-between hover:border-teal-500/40 transition"
              >
                <div className="space-y-3">
                  ...
                  {photoUrl ? (
                    <div
                      ...
                      className="relative h-44 rounded-2xl overflow-hidden bg-black cursor-pointer group border border-slate-200 dark:border-[#1E293B]"
                    >
                      <img
                        src={photoUrl}
                        alt="Evidence"
                    ...
                    <div className="h-32 rounded-2xl bg-slate-50 dark:bg-[#0B0F17] border border-slate-200 dark:border-[#1E293B] flex items-center justify-center text-slate-400 text-xs font-semibold">
                  ...
                  <div className="p-3 rounded-2xl bg-slate-50 dark:bg-[#0B0F17] border border-slate-200 dark:border-[#1E293B] space-y-1.5 text-xs">
                    <div className="flex items-center justify-between text-[11px] font-black text-teal-700 dark:text-teal-400">
                    ...
                    <div className="flex justify-between text-[11px]">
                      <span className="text-slate-500 dark:text-slate-400">Waterlogging:</span>
                      <strong className={rep.waterlogging_detected ? "text-red-600 dark:text-red-400" : "text-slate-700 dark:text-slate-300"}>
          ...
          {filteredReports.length === 0 && (
            <div className="col-span-full p-12 text-center text-slate-500 text-xs bg-white dark:bg-[#131B2A] border border-slate-200 dark:border-[#1E293B] rounded-3xl">
