    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-8 bg-[#FFFFFF] dark:bg-[#111C2E] border border-[#E2E8F0] dark:border-[#243244] rounded-2xl p-5 sm:p-6 shadow-sm space-y-4">
          ...
          <div className="lg:col-span-4 bg-[#FFFFFF] dark:bg-[#111C2E] border border-[#E2E8F0] dark:border-[#243244] rounded-2xl p-5 sm:p-6 shadow-sm space-y-4 flex flex-col justify-between">
            <div className="flex items-center gap-2">
            ...
            <div className="space-y-1.5 pt-2 border-t border-[#E2E8F0] dark:border-[#243244]">
              {data?.category_breakdown?.map((item) => (
                <div key={item.name} className="flex items-center justify-between text-xs">
                  ...
                  <span className="font-bold text-[#0F172A] dark:text-[#F8FAFC]">{item.value} reports</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="lg:col-span-12 bg-[#FFFFFF] dark:bg-[#111C2E] border border-[#E2E8F0] dark:border-[#243244] rounded-2xl p-5 sm:p-6 shadow-sm space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
              ...
              {data?.report_volume && data.report_volume.length > 0 ? (
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={data.report_volume}>
                    ...
                    />
                    <Legend wrapperStyle={{ fontSize: "11px", paddingTop: "8px" }} />
                    <Bar dataKey="total_reports" name="Total Ingested Reports" fill="#0F766E" radius={[6, 6, 0, 0]} />
                    <Bar dataKey="verified_reports" name="Officer Verified Reports" fill="#16A34A" radius={[6, 6, 0, 0]} />
                  </BarChart>
                </ResponsiveContainer>
              ) : null}
            </div>
